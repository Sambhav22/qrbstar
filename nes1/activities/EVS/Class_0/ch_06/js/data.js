  ...
  activityData = {
    ...
    questions: shuffleQues([
      shuffleOptions({
          ...
          correctAnswer: "Food grains and spices",
         }),
      shuffleOptions({
      ...
      shuffleOptions({
          ...
          correctAnswer: "Take food according to your diet",
         }),
      shuffleOptions({
          question:
          ...
          correctAnswer: "Do not store food for 3-4 days in the fridge",
         }),
      shuffleOptions({
          question:
          ...
          correctAnswer: "Fruits, food grains, and spices",
         }),
      shuffleOptions({
          question:
          ...
          correctAnswer: "Consume food according to your diet",
         }),
      shuffleOptions({
          question:
      ...
      shuffleOptions({
          ...
          correctAnswer: "To grow food for us",
         }),
      shuffleOptions({
          ...
          correctAnswer: "To avoid littering",
         }),
      shuffleOptions({
          ...
          correctAnswer: "Do not throw food anywhere",
           }),
    ]),
  }
}
