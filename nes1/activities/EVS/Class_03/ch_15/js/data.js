  ...
  activityData = {
    ...
    questions: shuffleQues([
      ...
      shuffleOptions({
          ...
          correctAnswer: "b) Puts it in the sun to dry",
         }),
      shuffleOptions({
      ...
      shuffleOptions({
          ...
          correctAnswer: "b) Potter's wheel",
         }),
      shuffleOptions({
          ...
          correctAnswer: "b) Digging the ground for clay",
         }),
      shuffleOptions({
          ...
          correctAnswer: "c) To give it strength",
         }),
      shuffleOptions({
          ...
          correctAnswer: "b) Storing food, water, and grains",
         }),
      shuffleOptions({
          ...
          optionC: "Jewelry",
          correctAnswer: "b) Diyas and earthen lamps",
         }),
      shuffleOptions({
          ...
          correctAnswer: "c) Lighting houses with diyas",
         }),
      shuffleOptions({
          ...
          correctAnswer: "c) Jewelry, urns, pots, wall hangings, etc.",
           }),
    ]),
  }
}
  ...
  activityData = {
    ...
    questions: shuffleQues([
      ...
      shuffleOptions({
          ...
          correctAnswer: "c) Potter's wheel",
         }),
      shuffleOptions({
          question:
