export const chapter = "Chapter - 2: Seasons";
...
if (localStorage.getItem("activityNumber") == 1) {
  activityData = {
    ...
    questions: shuffleQues([
      ...
      shuffleOptions({
        question: "Who enters the pigeon's hollow during the pigeon's absence?",
        optionA: "Crow",
        optionB: "Rabbit",
        optionC: "Squirrel",
      ...
      shuffleOptions({
        ...
        optionA: "The cat listens to their problem and resolves it peacefully.",
  ...
  activityData = {
    ...
    questions: shuffleQues([
      ...
      shuffleOptions({
        ...
        optionA: "True",
        optionB: "False",optionC: "Uncertain",
        correctAnswer: "True",
     }),
      shuffleOptions({
        question:
