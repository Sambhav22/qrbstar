export const chapter = "Chapter - 1: Basics of Computers";
...
if (localStorage.getItem("activityNumber") == 1) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "What is a distinctive characteristic of a palmtop computer?",
        options: {
...
if (localStorage.getItem("activityNumber") == 2) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "Error Free Work: A computer does not make any _________.",
        options: {
          A: "Mistake",
          B: "Breaks",
          C: "Errors",
      ...
      {
        question: "Multitasking: A computer can do many _________ at a time.",
        options: {
          A: "Jobs",
          B: "Tasks",
          C: "Chores",
