export const chapter = "Chapter - 3: Exploring Apps";
  ...
  activityData = {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: "C) Click on 'Start' button when the stopwatch appears",
      },
      {
...
if (localStorage.getItem("activityNumber") == 3) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "The Clock application allows users to delete saved alarms.",
        optionA: "True",
        optionB: "False",correctAnswer: "True",
      },
    ],
