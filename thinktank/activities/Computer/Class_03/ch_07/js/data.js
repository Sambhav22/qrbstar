export const chapter = "Chapter - 7: Working with MSWLogo";
...
if (localStorage.getItem("activityNumber") == 2) {
  activityData = {
    ...
    questions: [
      {
        question: "In MSWLogo, the pen used for drawing is called a _________.",
        optionA: "Pencil",
        optionB: "Brush",
        optionC: "Turtle",
...
if (localStorage.getItem("activityNumber") == 3) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "The Trace button in MSWLogo is used for executing commands.",
        optionA: "True",
        optionB: "False",correctAnswer: "False",
      },
      {
