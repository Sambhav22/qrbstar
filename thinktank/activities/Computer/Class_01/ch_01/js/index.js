const chapter = "Chapter - 1: Machines and Computer";
const noOfActivities = 3;
...
for (let i = 1; i <= noOfActivities; i++) {
  activityBtns += `<a class="px-4 py-2 m-3 font-bold text-white bg-red-600 border rounded-md cursor-pointer" data-activity="${i}">Quiz ${i}</a>`;
}
