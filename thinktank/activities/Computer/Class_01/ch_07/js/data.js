export const chapter = "Chapter - 7: Drawing in Tux Paint";
...
if (localStorage.getItem("activityNumber") == 1) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "Which tool provides colorful effects like fill and blur?",
        options: {
          a: "New tool",
          b: "Paint tool",
          c: "Magic tool",
...
if (localStorage.getItem("activityNumber") == 2) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "The ________ tool in Tux Paint helps create a new drawing.",
        options: {
          a: "Lines",
          b: "New",
          c: "Magic",
