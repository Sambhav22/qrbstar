export const chapter = "Chapter - 2: Computer Parts";
...
if (localStorage.getItem("activityNumber") == 3) {
  activityData = {
    ...
    questions: [
      {
        question: "The monitor displays the work that we do on the computer.",
      ...
      {
        question: "Printer helps to print the output of a computer on paper.",
      ...
      {
        question: "CPU controls and manages the overall working of a computer.",
        options: [
