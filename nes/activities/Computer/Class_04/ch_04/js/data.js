  ...
  activityData = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Ganges Canal", "Brahmaputra Canal", "Sutlej-Yamuna Link"],
        answer: "Ganges Canal",
      },
    ],
  };
...
if (localStorage.getItem("activityNumber") == 3) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "Free-form selection is used to select only square regions.",
        options: ["True", "False"],
        answer: "False",
      },
      {
      ...
      {
        question: "The Flip option in Paint allows you to change image colors.",
        options: ["True", "False"],
        answer: "False",
      },
      {
