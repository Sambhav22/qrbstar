    ...
    questions: [
      {
        questions: [
          ...
          {
            question:
              "In what capacity does technology aid in shops and malls?",
            options: {
    ...
    questions: [
      {
        questions: [
          {
            question:
              "Hospitals use technology to store information of patients.",
            options: {
              a: "True",
              b: "False",
            },
          ...
          {
            question:
              "In hospitals, technology is used to examine the patients.",
            options: {
              a: "True",
              b: "False",
            },
