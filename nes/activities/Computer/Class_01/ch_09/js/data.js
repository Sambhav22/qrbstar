...
if (localStorage.getItem("activityNumber") == 2) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "Mountains and rivers are examples of ___________ things.",
      ...
      {
        question: "Plants and animals are categorized as ___________ things.",
        options: ["Artificial", "Natural", "Synthetical"],
        answer: "Natural",
      },
      {
        question: "___________ is the ability to create by human intelligence.",
...
if (localStorage.getItem("activityNumber") == 3) {
  activityData = {
    ...
    questions: [
      ...
      {
        question: "Intelligence involves the ability to understand and learn.",
        optionA: "True",
        optionB: "False",
        answer: "True",
      },
