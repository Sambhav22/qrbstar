...
if (localStorage.getItem("activityNumber") == 1) {
  activityData = {
    ...
    questions: shuffleQues([
      shuffleOptions(
        {
          question: "What is the major source of water for India's economy?",
          optionA: "Lakes",
          optionB: "Rivers",
      ...
      shuffleOptions({
          question:
            "Which regions in India face scarcity of water, especially in the summer season?",
          optionA: "North India",
          optionB: "South India",
      ...
      shuffleOptions({
          question:
            "What is the proposed solution to overcome droughts in one region and floods in another?",
      ...
      shuffleOptions({
          question:
            "What is a major concern regarding India's water resources mentioned in the text?",
      ...
      shuffleOptions({
          question:
            "Which of the following projects is mentioned as an example of interlinking of rivers in North India?",
      ...
      shuffleOptions({
          question:
            "What impact does the text suggest the growing population has on water scarcity?",
      ...
      shuffleOptions({
          question:
            "What is the expected per capita availability of water by the year 2025?",
      ...
      shuffleOptions({
          question:
            "What environmental issues are associated with the interlinking of rivers, according to the text?",
      ...
      shuffleOptions({
          question:
            "What objections are mentioned regarding the interlinking of rivers between states?",
      ...
      shuffleOptions({
          question:
            "What does the text suggest as a prerequisite before starting massive work for interlinking of rivers?",
  ...
  activityData = {
    ...
    questions: shuffleQues([
      shuffleOptions(
        {
          question:
            "India's economy is primarily driven by the northeast monsoon.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "False",
        }),
      shuffleOptions({
          question:
            "The southwest monsoon in India occurs from June to September.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "True",
        }),
      shuffleOptions({
          question:
            "Interlinking of rivers is a straightforward solution to address water scarcity and floods in India.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "False",
        }),
      shuffleOptions({
          question:
            "India is self-sufficient in terms of grain production, but storage facilities are a major issue.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "True",
        }),
      shuffleOptions({
          question:
            "The National Rail Museum in Delhi was inaugurated in its present form in 1995.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "True",
        }),
      shuffleOptions({
          question:
            "The Periyar Project is an example of river interlinking in South India.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "False",
        }),
      shuffleOptions({
          question:
            "The Calico Museum of Textiles focuses primarily on aviation history.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "False",
        }),
      shuffleOptions({
          question:
            "The concept of river interlinking in India has faced no objections from any state.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "False",
        }),
      shuffleOptions({
          question:
            "Louisa worked as a nurse during the Civil War and grew very ill due to her hard work.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "True",
        }),
      shuffleOptions({
          question:
            "The Air Force Museum in Palam, New Delhi, displays the maximum number of rail simulators in the world.",
          optionA: "True",
          optionB: "False",
          correctAnswer: "False",
   }),
